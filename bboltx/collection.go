...
func (b *Bucket[K, V]) EntryList(ctx context.Context, opts ...ListOption[K]) (*collectionlist.List[Entry[K, V]], error) {
...
func (b *Bucket[K, V]) KeyList(ctx context.Context, opts ...ListOption[K]) (*collectionlist.List[K], error) {
	keys, err := b.Keys(ctx, opts...)
	if err != nil {
		return nil, err
	}
...
func (b *Bucket[K, V]) ValueList(ctx context.Context, opts ...ListOption[K]) (*collectionlist.List[V], error) {
	values, err := b.Values(ctx, opts...)
	if err != nil {
		return nil, err
	}
...
func (r *Repository[K, V]) EntryList(ctx context.Context, opts ...ListOption[K]) (*collectionlist.List[Entry[K, V]], error) {
	return r.Bucket().EntryList(ctx, opts...)
}
...
func (r *Repository[K, V]) KeyList(ctx context.Context, opts ...ListOption[K]) (*collectionlist.List[K], error) {
	return r.Bucket().KeyList(ctx, opts...)
}
...
func (r *Repository[K, V]) ValueList(ctx context.Context, opts ...ListOption[K]) (*collectionlist.List[V], error) {
	return r.Bucket().ValueList(ctx, opts...)
}
